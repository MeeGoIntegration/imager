# -*- coding: utf-8 -*-
#
# BOSS Imager documentation build configuration file, created by
...
project = u'BOSS Imager'
copyright = u'2011, Islam Amer, Aleksi Suomalainen'
...
htmlhelp_basename = 'BOSSImagerdoc'
...
latex_documents = [
  ('index', 'BOSSImager.tex', u'BOSS Imager Documentation',
   u'Islam Amer, Aleksi Suomalainen', 'manual'),
]
...
man_pages = [
    ('index', 'bossimager', u'BOSS Imager Documentation',
     [u'Islam Amer, Aleksi Suomalainen'], 1)
]
