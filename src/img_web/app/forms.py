...
class UploadFileForm(forms.Form):
    ...
    architecture = forms.ChoiceField(label='Architecture', choices=[('i586', "i586"), ('armv7l',"armv7l")], help_text="Target architecture of the image you want to build from your customized kickstart.")
