...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageJob.user'
        db.add_column('app_imagejob', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ImageJob.user'
        db.delete_column('app_imagejob', 'user_id')
