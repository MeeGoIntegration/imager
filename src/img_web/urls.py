...
app_urlpatterns = patterns('',
    ...
    url(r'queue/filter/$', 'img_web.app.views.queue', {'filter' : True}, name='img-app-queue-filter'),
    url(r'update/$', 'img_web.app.views.update', name='img-app-update'),
    url(r'remove/$', 'img_web.app.views.remove', name='img-app-remove'), 
    url(r'remove/confirm/(?P<msgid>\S+)$', 'img_web.app.views.confirm_remove', name='img-app-confirm-remove'), 
